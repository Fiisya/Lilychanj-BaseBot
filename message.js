...
Risa.sendMessage(m.chat, { video: { url: anu.result.url}, caption: `Auto Download ✅`}, {quoted: m})
await Risa.sendMessage(m.chat, { react: { text: "☑️",key: m.key,}})   
} else if (budy.match(`tiktok.com`)) {
await Risa.sendMessage(m.chat, { react: { text: "⏱️",key: m.key,}})   
let anu = await fetchJson(`https://btch.us.kg/download/v2/ttdl?url=${budy}`)
Risa.sendMessage(m.chat, { video: { url: anu.result.video}, caption: `Auto Download ✅`}, {quoted: m})
await Risa.sendMessage(m.chat, { react: { text: "☑️",key: m.key,}})   
} else if (budy.match(`facebook.com`)) {
await Risa.sendMessage(m.chat, { react: { text: "⏱️",key: m.key,}})   
let anu = await fetchJson(`https://btch.us.kg/download/fbdl?url=${budy}`)
Risa.sendMessage(m.chat, { video: { url: anu.result.Normal_video}, caption: `Auto Download ✅`}, {quoted: m})
await Risa.sendMessage(m.chat, { react: { text: "☑️",key: m.key,}})   
} else if (budy.match(`youtube.com|youtu.be`)) {
await Risa.sendMessage(m.chat, { react: { text: "⏱️",key: m.key,}})   
let anu = await fetchJson(`https://btch.us.kg/download/ytdl?url=${budy}`)
Risa.sendMessage(m.chat, { video: { url: anu.result.mp4}, caption: ``}, {quoted: m})
await Risa.sendMessage(m.chat, { react: { text: "☑️",key: m.key,}})   
} 
} catch (err) {
await Risa.sendMessage(m.chat, { react: { text: "✖️",key: m.key,}})   
...
if (!isCreator) return reply3("*[ sʏsᴛᴇᴍ ] ᴍᴀᴀғ ɪɴɪ ᴋʜᴜsᴜs ᴏᴡɴᴇʀ")
                ...
                if (q == 'on') {
                    ...
                    reply3(`Successfully Changed Auto Download To ${q}`)
                } else if (q == 'off') {
                    db.data.settings[botNumber].autodownload = false
                    reply3(`Successfully Changed Auto Download To ${q}`)
                } else {
                await Risa.sendMessage(m.chat, { poll: { name: 'Pilih On Or Off?', values: [`${command} on`,`${command} off`] } }, { quoted: m})
}
            break
